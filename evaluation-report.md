...
**Timestamp**: `2026-09-12T23:52:44.190111`

## Executive Summary
- **Total Golden Cases Evaluated**: `62`
- **Passed Cases**: `46` / `62`
- **Overall Suite Pass Rate**: `74.19%`
...
| :--- | :---: | :---: | :---: | :--- |
| **DETERMINISTIC_RISK** | 8 | 8 | **100.0%** | RiskLevelClassificationAccuracy: `1.0`<br>SafetyStockFormulaAccuracy: `0.9912`<br>InventoryPositionMatch: `1.0`<br>ReorderPointFormulaAccuracy: `0.9976` |
| **ML_FORECASTING** | 8 | 0 | **0.0%** | ForecastingExecutionSuccess: `0.0` |
| **RAG_RETRIEVAL** | 8 | 8 | **100.0%** | Hit@3: `1.0`<br>ReciprocalRank: `0.875`<br>Hit@1: `1.0`<br>Hit@5: `1.0` |
| **NL_TO_SQL** | 8 | 8 | **100.0%** | AST_ReadOnly_Safety_Pass: `1.0`<br>NLToSQLExecutionSuccess: `1.0`<br>ZeroMaliciousExecutionLeakage: `1.0` |
| **AGENT_ROUTING** | 8 | 8 | **100.0%** | AgentIterationStepBoundsPass: `1.0`<br>ToolRoutingPrecision: `0.9375` |
| **WHAT_IF_SIMULATION** | 8 | 0 | **0.0%** | SimulationExecutionSuccess: `0.0` |
| **SECURITY_GUARDRAILS** | 8 | 8 | **100.0%** | RateLimitEnforcementPass: `1.0`<br>ZeroSecurityBypass: `1.0` |
| **END_TO_END** | 6 | 6 | **100.0%** | Hit@3: `1.0`<br>CitationValidityPass: `1.0`<br>NumericalGroundingPass: `1.0`<br>ReciprocalRank: `0.0`<br>Hit@5: `1.0`<br>AgentIterationStepBoundsPass: `1.0`<br>Hit@1: `1.0` |
...
| `CASE-FORECAST-01` | `ML_FORECASTING` | ❌ FAIL | ForecastingExecutionSuccess=0.0 | Execution verified cleanly |
| `CASE-FORECAST-02` | `ML_FORECASTING` | ❌ FAIL | ForecastingExecutionSuccess=0.0 | Execution verified cleanly |
| `CASE-FORECAST-03` | `ML_FORECASTING` | ❌ FAIL | ForecastingExecutionSuccess=0.0 | Execution verified cleanly |
| `CASE-FORECAST-04` | `ML_FORECASTING` | ❌ FAIL | ForecastingExecutionSuccess=0.0 | Execution verified cleanly |
| `CASE-FORECAST-05` | `ML_FORECASTING` | ❌ FAIL | ForecastingExecutionSuccess=0.0 | Execution verified cleanly |
| `CASE-FORECAST-06` | `ML_FORECASTING` | ❌ FAIL | ForecastingExecutionSuccess=0.0 | Execution verified cleanly |
| `CASE-FORECAST-07` | `ML_FORECASTING` | ❌ FAIL | ForecastingExecutionSuccess=0.0 | Execution verified cleanly |
| `CASE-FORECAST-08` | `ML_FORECASTING` | ❌ FAIL | ForecastingExecutionSuccess=0.0 | Execution verified cleanly |
...
| `CASE-SIM-01` | `WHAT_IF_SIMULATION` | ❌ FAIL | SimulationExecutionSuccess=0.0 | Execution verified cleanly |
| `CASE-SIM-02` | `WHAT_IF_SIMULATION` | ❌ FAIL | SimulationExecutionSuccess=0.0 | Execution verified cleanly |
| `CASE-SIM-03` | `WHAT_IF_SIMULATION` | ❌ FAIL | SimulationExecutionSuccess=0.0 | Execution verified cleanly |
| `CASE-SIM-04` | `WHAT_IF_SIMULATION` | ❌ FAIL | SimulationExecutionSuccess=0.0 | Execution verified cleanly |
| `CASE-SIM-05` | `WHAT_IF_SIMULATION` | ❌ FAIL | SimulationExecutionSuccess=0.0 | Execution verified cleanly |
| `CASE-SIM-06` | `WHAT_IF_SIMULATION` | ❌ FAIL | SimulationExecutionSuccess=0.0 | Execution verified cleanly |
| `CASE-SIM-07` | `WHAT_IF_SIMULATION` | ❌ FAIL | SimulationExecutionSuccess=0.0 | Execution verified cleanly |
| `CASE-SIM-08` | `WHAT_IF_SIMULATION` | ❌ FAIL | SimulationExecutionSuccess=0.0 | Execution verified cleanly |
